                ...
                <div class="card card-secondary">
                            ...
                            @if ($dataCso->statusdoc == 'P')
                                <div class="col-md-4 text-end">
                                    <div class="d-flex flex-row-reverse">
                                        ...
                                        <div class="me-2">
                                            <form method="POST" action="{{ route('approval-avalan.store') }}">
                                                @csrf
                    ...
                    <div class="card-body" style="background-color: #f8f8f8; max-height: 1330px; overflow: auto;">
                        <h2 style="text-align: center">
                            LAPORAN HASIL PELAKSANAAN {{ substr($dataCso->doccsoid, 0, 3) }} BATCH
                        </h2>
                        <div>
                            <h4>
                                I. PELAKSANAAN {{ substr($dataCso->doccsoid, 0, 3) }} BATCH
                            </h4>
                        ...
                        <div style="margin-top: 1cm">
                            <h4>
                                II. SUSUNAN TIM @if (substr($dataCso->doccsoid, 0, 3) == 'CSO')
                                    CEK STOK OPNAME BATCH
                                @else
                                    CEK STOK SAMPLING BATCH
                                @endif
                            </h4>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($dataRekapitulasi as $dataPerhitungan)
                                        @php
                                            ...
                                            $dataPerhitungan->kesalahan_admin_selisih;
                                            $totalItemOk += $item_ok;
