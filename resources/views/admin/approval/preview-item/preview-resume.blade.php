                            ...
                            @if ($dataCso->statusdoc == 'P')
                                <div class="col-md-4 text-end">
                                    <div class="d-flex flex-row-reverse">
                                        ...
                                        <div class="me-2">
                                            <form method="POST" action="{{ route('approval-stok.store') }}">
                                                @csrf
                                                <input type="text" name="trsidresume" value="{{ $trsidresume }}" hidden>
                                                @if (Auth::user()->level == 6)
                                                    <button class="btn btn-primary text-white" type="submit"
                                                        name="wrhapproval" value="1"
                                                        @if ($dataCso->wrhapproval == 1) disabled @endif>
                                                        Approve from Warehouse
                                                    </button>
                                                @elseif (Auth::user()->level == 7)
                                                    <button class="btn btn-primary text-white" type="submit"
                                                        name="facapproval" value="1"
                                                        @if ($dataCso->facapproval == 1) disabled @endif>
                                                        Approve from FAC
                                                    </button>
                                                @elseif (Auth::user()->level == 8)
                                                    <button class="btn btn-primary text-white" type="submit"
                                                        name="purapproval" value="1"
                                                        @if ($dataCso->purapproval == 1) disabled @endif>
                                                        Approve from Purchasing
                                                    </button>
                                                @elseif (Auth::user()->level == 9)
                                                    <button class="btn btn-primary text-white" type="submit"
                                                        name="kaopsapproval" value="1"
                                                        @if ($dataCso->kaopsapproval == 1) disabled @endif>
                                                        Approve from Ka Ops
                                                    </button>
                                                @elseif (Auth::user()->level == 10)
                                                    <button class="btn btn-primary text-white" type="submit"
                                                        name="regmenapproval" value="1"
                                                        @if ($dataCso->regmenapproval == 1) disabled @endif>
                                                        Approve from RegMen
                                                    </button>
                                                @elseif (Auth::user()->level == 2)
                                                    <button class="btn btn-primary text-white" type="submit"
                                                        name="staffstokapproval" value="1"
                                                        @if ($dataCso->staffstokapproval == 1) disabled @endif>
                                                        Approve from Staff Stok
                                                    </button>
                                                @elseif (Auth::user()->level == 5)
                                                    <button class="btn btn-primary text-white" type="submit"
                                                        name="picwrhapproval" value="1"
                                                        @if ($dataCso->picwrhapproval == 1) disabled @endif>
                                                        Approve from PIC Warehouse
                                                    </button>
                                                @endif
                                            </form>
                                        </div>
                                    ...
                                    @if (count($dataAnalisator) > 0)
                                        @foreach ($dataAnalisator as $analisator)
                                            <tr class="tr-body">
                                                ...
                                                <td class="td-content" style="padding: 8px">{{ $analisator->departemen }}
                                                </td>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($dataRekapitulasi as $dataPerhitungan)
                                        @php
                                            ...
                                            $item_ok =
                                                $dataPerhitungan->item_ok +
                                                $dataPerhitungan->tidak_hitung +
                                                $faktorAdminSelisih;
                                            $totalItemOk += $item_ok;
                                            $totalItemSelisih += $dataPerhitungan->item_selisih;
                                            $itemTidakHitung += $dataPerhitungan->tidak_hitung;
                                            // $itemAdaKesalahanAdmin = $dataPerhitungan->total_item - $dataPerhitungan->item_selisih;
                                        @endphp
                                    ...
                                    @if (substr($dataCso->doccsoid, 0, 3) == 'CSS')
                                        <tr class="tr-rekapitulasi-global" style="background-color: #007efc90; font-weight: bolder;">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($dataItemTertukar as $itemTertukar)
                                        ...
                                        <tr class="tr-selisih">
                                            ...
                                            <td class="td-content" style="text-align: center">{{ $itemTertukar->nodoc }}
                                            </td>
                                            <td class="td-content" style="text-align: center">
                                    ...
                                    @foreach ($dataItemSelisih as $itemSelisih)
                                        @if (abs($itemSelisih->hasilcso - ($itemSelisih->onhand - $itemSelisih->koreksi - $itemSelisih->deviasi)) !=
                                            ...
                                            @endphp
                                            <tr class="tr-selisih">
                                                <td class="td-content" style="text-align: center">{{ $loop->iteration }}
                                                </td>
                                                <td class="td-content" style="padding-left: 5px">
                                                    {{ $itemSelisih->itemname }}
                                                </td>
                                                <td class="td-content" style="text-align: center">
                                    ...
                                    @if (count($dataItemSelisih) > 0)
                                        <tr class="tr-body-calculator" style="font-size: 9pt">
                                            ...
                                            @if (Auth::user()->level != 5 && Auth::user()->level != 6)
                                                ...
                                                <td class="td-content" style="color: red">Rp.
                                                    {{ number_format($totalNominalSelisihMinusSelisih, 2, ',', '.') }}
                                                </td>
                                            @endif
                                            <td class="td-content" style="color: red">Rp.
                            ...
                            <table class="mt-5" style=" border-collapse: collapse;width: 100%;"
                                ...
                                <body>
                                    ...
                                    <tr class="tr-selisih">
                                        ...
                                        <td class="td-content" style="text-align: center">{{ $itemTidakHitung->nodoc }}
                                        </td>
                                        <td class="td-content" style="text-align: center">
                                            {{ $itemTidakHitung->keterangan }}
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tr>
                                    @if (count($dataItemTidakHitung) > 0)
                                        <tr class="tr-body-calculator" style="font-size: 9pt">
                                            <td class="td-content" colspan="3">Total</td>
                                            <td class="td-content">
                                                {{ number_format($totalSlsLbrTidakHitung, 2, ',', '.') }}
                                            </td>
                                            <td class="td-content">
                                            ...
                                            @if (Auth::user()->level != 5 && Auth::user()->level != 6)
                                                <td class="td-content">Rp.
                                                    {{ number_format($totalHppTidakHitung, 2, ',', '.') }}
                                                </td>
                                                <td class="td-content">Rp.
                                                    {{ number_format($totalNominalSelisihPlusTidakHitung, 2, ',', '.') }}
                                                </td>
                                                <td class="td-content" style="color: red">Rp.
                                                    {{ number_format($totalNominalSelisihMinusTidakHitung, 2, ',', '.') }}
                                                </td>
                                            @endif
                                            <td class="td-content" style="color: red">Rp.
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data3BulanTerakhir as $data)
                                        ...
                                        <tr style="font-size: 9pt;text-align: center;">
                                            ...
                                            <td class="td-content">
                                                {{ round(($data->item_ok / $data->item_ada) * 100, 2) }}%</td>
                                        </tr>
                                    @endforeach
                                    @if (count($data3BulanTerakhir) > 0)
                                        <tr class="tr-body-calculator" style="font-size: 10pt">
                                            ...
                                            <td class="td-content">
                                                {{ round(($totalItemSesuai3Bulan / $totalItem3Bulan) * 100, 2) }}%</td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
