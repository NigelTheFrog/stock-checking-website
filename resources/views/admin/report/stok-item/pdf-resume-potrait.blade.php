...
<body>
    ...
    <div>
        ...
        <table>
            <thead>
                <tr class="tr-head">
                    <th class="th-pic-cso" style="width: 4%">No</th>
                    <th class="th-pic-cso" style="width: 20%">Nama Pencatat</th>
                    <th class="th-pic-cso" style="width: 13%">Departemen</th>
                    <th class="th-pic-cso" style="width: 13%">Lokasi</th>
                    <th class="th-pic-cso" style="width: 60%">Catatan tentang Pencatat</th>
                </tr>
            </thead>
            <tbody>
                @if (count($dataPelaku) > 0)
                    @foreach ($dataPelaku as $pelaku)
                        <tr class="tr-body">
                            ...
                            <td class="td-content" style="padding: 8px; font-size: 9pt">{{ $pelaku->locationname }}</td>
