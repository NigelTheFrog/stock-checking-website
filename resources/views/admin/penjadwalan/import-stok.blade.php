...
@section('content')
                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body" style="background-color:rgb(248, 248, 248)">
                        <div class="d-flex justify-content-between mb-2" style="width: 25%">
                            <button type="button" class="btn btn-primary float-end" onclick="openModalImport()"
                                {{-- data-bs-toggle="modal" data-bs-target="#modalImportItem" --}}
                        ...
                        <form id="deleteform"
                            action="{{ route('import-stok.destroy', ['checkboxDelete', 'key' => $csoType]) }}"
                            method="POST" class="needs-validation mx-3" novalidate>
                            @csrf
                            @method('DELETE')
                            ...
                            <table
                                class="table table-sm table-bordered table-hover sticky-header table-responsive small table-striped"
                                ...
                                <thead class="table-dark" style="position: sticky;top: 0;z-index:999;">
                                    <tr class="text-center">
                                        ...
                                        <th class="align-middle" style="width:25%">Kode Item</th>
                                        <th class="align-middle" style="width:25%">Nama Item</th>
                                        ...
                                        <th class="align-middle" style="width:8%">Jenis</th>
                        ...
                        <form action="{{ route('import-stok.store') }}" method="POST" class="needs-validation"
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select class="form-select text-secondary" name="jenis" aria-label="pilih level"
                                        required>
                                        <option value="0">Finish Good</option>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row ps-2 mb-2 pe-2 bg-light align-items-center" style="height: 50px">
    ...
    <div class="modal fade text-left" id="modalPilihLingkup" tabindex="-1">
        <div class="modal-dialog modal modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="mdlMoreLabel">Pilih Lingkup CSO</h1>
                    <button type="button" class="btn-close align-middle" onclick="openModalImport()"
                        aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select class="form-select text-secondary" id="jenis" aria-label="pilih level" required>
                                <option value="0">Finish Good</option>
                                <option value="1">Raw Material</option>
                            </select>
                            {{-- <div class="invalid-feedback">
                    ...
                    <button type="button" class="btn btn-primary float-end" id="buttonImpor"
                        onclick="submitImpor(this)">Simpan</button>
                </div>
            </div>
        </div>
    </div>
