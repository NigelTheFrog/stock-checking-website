...
$itemWrh = $wrhItem;
@endphp
{{-- <div style="max-height: 15vh overflow-y: auto; overflow-x:auto">
        ...
        <thead style='column-width: auto' >
            <tr>
                ...
                @foreach($itemWrh as $wrhItem)
                    <th class="align-middle" scope="col"> {{ $wrhItem->wrh }}</th>
                @endforeach
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                @foreach($itemWrh as $itemQty)
                    <td class="align-middle" style='white-space:nowrap;'> {{ $itemQty->qty }}</td>
                @endforeach
            </tr>
        </tbody>
    </table>
...
<div style="max-height: 40vh;overflow-y: auto; margin-bottom: 2vh;">
    <table class="table table-sm shadow table-bordered border-dark small mb-3 text-center" style=" table-layout: auto;">
        <thead>
            <tr>
                <th class="align-middle border-dark" style="background-color:	#E5E4E2;">Warehouse</th>
                <th class="align-middle border-dark" style="background-color:	#E5E4E2;">Onhand</th>
                {{-- <th class="align-middle" style="background-color:	#E5E4E2;">Status</th> --}}
                <th class="align-middle border-dark" style="background-color:	#E5E4E2;">Qty cso</th>
                <th class="align-middle border-dark" style="background-color:	#E5E4E2;">Selisih</th>
    ...
    <table id="tabelDetailItem" class="table table-sm table-hover table-bordered table-responsive-md small shadow-sm">
        <thead class="table-secondary">
            <tr>
                ...
                <th scope="col" class="text-center align-middle">Pencatat</th>
                ...
                <th scope="col" class="text-center align-middle">Gudang</th>
        ...
        <tbody>
            @foreach ($tableDetailDashboard as $detail)
                ...
                <tr>
                    ...
                    <td>{{ $detail->grade }} @if ($detail->description != null) ({{ $detail->description }}) @endif</td>
                    <td>{{ $detail->remark }}</td>
                </tr>
            @endforeach
        </tbody>
