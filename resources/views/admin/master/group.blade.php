    ...
    <div class="row justify-content-md-center">
        ...
        <div class="col-5">
            <div class="card mt-2">
                ...
                <div class="card-body" style="background-color:rgb(248, 248, 248)">
                    <form id="forminput" action="{{route("group.store")}}" method="POST" class="needs-validation mx-3" novalidate >
                        @csrf
...
<script>
    function openModalEdit(button) {
        ...
        $('#editform').attr('action',`{{url('admin/master/group/${groupid}')}}`);
    }
    ...
    function openModalDelete(button) {
        ...
        $('#deleteform').attr('action',`{{url('admin/master/group/${groupid}')}}`);    
    }
