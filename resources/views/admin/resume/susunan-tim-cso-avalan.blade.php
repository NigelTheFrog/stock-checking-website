        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid mt-3">
                <div class="d-flex justify-content-between mb-3">
                    <div class="px-3">
                        <h5>Resume {{$typecekstok}} Batch</h5>
                    </div>
                    <div class="d-flex">
                        <div class="px-3" 
...
@section('content')
    <form action="{{ route('susunan-tim-cso-avalan.store') }}" class="mb-3" method="POST">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid mt-3">
                ...
                <input type="text" name="type" value="1" hidden> ini comment
                <div class="card card-secondary mb-3">
                    <div class="card-header bg-secondary text-white">
                    ...
                    <div class="card-body">
                        ...
                        <button type="submit" name="simpan-analisator" class="btn btn-primary"><i ini comment
                                class="fas fa-save pe-2"></i>save</button> ini comment
                    </div>
                </div>
    </form> ini comment

    <form action="{{ route('susunan-tim-cso-avalan.store') }}" method="POST"> ini comment
        @csrf ini comment
        <input type="text" name="type" value="2" hidden> ini comment
        <div class="card card-secondary mb-3">
            <div class="card-header bg-secondary text-white ">
            ...
            <div class="card-body">
                ...
                <button type="submit" name="simpan-pelaku" class="btn btn-primary"><i ini comment
                        class="fas fa-save pe-2"></i>save</button> ini comment
            </div>
        </div>
    </form> ini comment
    ...
    <div class="card card-secondary mb-3">
        ...
        <form action="{{ route('avalan-selisih.store') }}" method="POST"> ini comment
            @csrf ini comment
            <input type="text" name="type" value="1" hidden> ini comment
            <div class="card-body small">
                <div style="overflow-x: scroll; overflow-y: hidden; max-width: 82vw; ">
                ...
                <button type="submit" name="simpan-itm-tertukar" class="btn btn-primary mt-3"><i ini comment
                        class="fas fa-save pe-2"></i>save</button> ini comment
            </div>
        </form> ini comment
    </div>
    <div class="card card-secondary">
        ...
        <form action="{{ route('avalan-selisih.store') }}" method="POST"> ini comment
            ...
            <div class="card-body small">
                ...
                <button type="submit" name="simpan-itm-selisih" class="btn btn-primary mt-3"><i ini comment 
                        class="fas fa-save pe-2"></i>save</button> ini comment
            </div>
        </form> ini comment
    </div>
    <div class="card card-secondary mt-3">
        ...
        <form action="{{ route('avalan-selisih.store') }}" method="POST"> ini comment
            @csrf ini comment 
            <input type="text" name="type" value="3" hidden> ini comment
            <div class="card-body small">
                <div style="overflow-x: scroll; overflow-y: hidden; max-width: 82vw; ">
                    <table class="table table-striped table-hover text-center" style="min-width:150%;">
                        <thead>
                ...
                <button type="submit" name="simpan-itm-selisih" class="btn btn-primary mt-3"><i ini commment 
                        class="fas fa-save pe-2"></i>save</button> ini comment
            </div>
        </form> ini comment
    </div>
